...
export default function ServiceCard({
  ...
  return (
    ...
    <Link
      href={href}
      className={cn(
        "group flex h-full w-max-3xl flex-col overflow-hidden rounded-4xl border border-gray-200 bg-[#0E2A47]/80 text-white  transition hover:-translate-y-2  hover:shadow-xl hover:shadow-[#0E2A47]/80 shadow-soft group ",
      )}
    >
      ...
      <div className="flex flex-1 flex-col gap-4 p-6 text-center justify-center mx-auto">
        ...
        <div className="mt-auto mx-auto text-center justify-center inline-flex w-max items-center gap-2 rounded-full border border-[#0E2A47] bg-white px-4 py-1.5 text-sm font-semibold text-[#0E2A47] transition group-hover:bg-[#d9b356] ">
          Explore
          <ArrowRight className="h-4 w-4" />
        </div>
      </div>
