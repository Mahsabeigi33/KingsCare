...
export default function Hero({
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[70vh] max-w-10xl flex-col  gap-12 px-2   md:pt-4 md:px-0 md:pb-12 lg:pt-4 lg:pb-12 lg:flex-row lg:items-center md:px-6 lg:pl-20 xl:pl-60 lg:md:justify-start">
        <div className="max-w-6xl text-white space-y-6   sm:px-4 md:px-6 p-8">
          {announcement ? (
            <div
              className="p-8 px-20 py-12 sm:px-6 sm:py-8
